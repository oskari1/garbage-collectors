...
public class ReceivedAmounts {
    private static final Logger logger = LoggerFactory.getLogger(Verifier.class);
    private HashMap<StoreInitializer, Integer> amts_map;
    private final PointsToInitializer pointsTo;
    
    public ReceivedAmounts(PointsToInitializer pointsTo, SootMethod method) {
    ...
    public void merge_amounts(ReceivedAmounts amounts) {
    ...
    public ReceivedAmounts receive_amount(MpqScalar delivered_amt, ValueBox store_reference) {
